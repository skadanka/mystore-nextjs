...
export default function ProductImages({ images }: { images: string[] }) {
    ...
    return (
        <div className="flex flex-col items-center w-full max-w-4xl mx-auto">
            {/* Main Centered Image */}
            <div className="w-[300px] h-[400px] md:w-[400px] md:h-[500px] mb-5 flex justify-center items-center relative">
                <Image
                ...
                />
                <div className="mt-4 text-lg font-semibold text-gray-700 absolute bottom-4 bg-gray-200 w-fit h-fit rounded-lg px-2">
                    {`${centeredImage + 1} / ${images.length}`}
                </div>
            </div>
            ...
            <div
                ref={scrollRef}
                className="relative w-full gap-4 flex items-center overflow-x-auto scroll-smooth cursor-grab active:cursor-grabbing select-none no-scrollbar sm:w-3/4"
            ...
            >
                ...
                <div className="flex-shrink-0 md:w-16 w-24 py-20"></div>

                {images.map((image, index) => (
                    <div
                        key={index}
                        className={`snap-center flex-shrink-0 image-item transition-all duration-200 ${centeredImage === index
                ...
                <div className="flex-shrink-0 md:w-16 w-24"></div>
            </div>
